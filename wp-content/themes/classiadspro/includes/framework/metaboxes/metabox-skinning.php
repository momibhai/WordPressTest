...
$options = array(
  ...
  array(
	...
	array(
		'id' => 'header_shadow',
		'type' => 'toggle',
		'name' => esc_html__('Header Shadow Bottom', 'classiadspro'),
		"default" => true,
	),
	array(
  ...
  array(
      "name" => esc_html__("Upload Logo", "classiadspro"),
      "desc" => esc_html__("Custom Logo for this page only.", "classiadspro"),
      "id" => "logo",
      "default" => "",
      "type" => "upload"
  ),
  ...
  array(
      "name" => esc_html__("Upload Transparent Header Logo", "classiadspro"),
  ...
  array(
      "name" => esc_html__("Upload Transparent Header Retina Logo", "classiadspro"),
      "desc" => esc_html__("Use this option if you want your logo appear crystal clean in retina devices(eg. macbook retina, ipad, iphone).", "classiadspro"),
