					...
					<ul class="directorypress-list-group">
						...
						<?php if (!empty($directorypress_object->submit_pages_all)): ?>
							<?php if(in_array($package->id, directorypress_package_purchase_limit($packages))): ?>
								<div class="directorypress-list-group-item pp-button" data-toggle="tooltip" title="<?php echo esc_attr__('You have already submitted maximum listings in this package.', 'directorypress-frontend'); ?>">
