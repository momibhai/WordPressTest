...
class Form_Builder_Wp_Widget_Radio extends Form_Builder_Wp_Widget_Base {

	public function get_name() {
		return 'wpfb_form_radio';
	}

	public function get_title() {
		return __( 'Radio Field', 'form-builder-wp' );
	}

	public function get_icon() {
		return 'wpfb-form-icon-widget-radio';
	}
...
function wpfb_form_field_radio_validation_filter($result, $field){
	$name = $field->get_name();
...
add_filter( 'wpfb_form_validate_radio', 'wpfb_form_field_radio_validation_filter', 10, 2 );
