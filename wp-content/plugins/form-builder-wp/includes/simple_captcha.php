...
if ( ! class_exists( 'Form_Builder_Wp_Simple_Captcha', false ) ) {
	class Form_Builder_Wp_Simple_Captcha {
		public $chars;
		public $char_length;
		public $fonts;
		public $tmp_dir;
		...
		public function __construct() {
			...
			$this->fonts = array(
				FORM_BUILDER_WP_PATH . 'assets/fonts/gentium/GenBkBasR.ttf',
				FORM_BUILDER_WP_PATH . 'assets/fonts/gentium/GenBkBasI.ttf',
				FORM_BUILDER_WP_PATH . 'assets/fonts/gentium/GenBkBasBI.ttf',
				FORM_BUILDER_WP_PATH . 'assets/fonts/gentium/GenBkBasB.ttf',
			);
		
			/* Directory temporary keeping CAPTCHA images and corresponding text files */
			$this->tmp_dir = path_join( FORM_BUILDER_WP_PATH, 'tmp' );
