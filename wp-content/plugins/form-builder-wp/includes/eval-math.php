...
if ( ! class_exists( 'Form_Builder_Wp_Eval_Math', false ) ) {
	/**
	 * Class Form_Builder_Wp_Eval_Math. Supports basic math only (removed eval function).
	 *
	 * Based on EvalMath by Miles Kaufman Copyright (C) 2005 Miles Kaufmann http://www.twmagic.com/.
	 */
	class Form_Builder_Wp_Eval_Math {
		...
		private static function nfx( $expr ) {
			...
			$index = 0;
			$stack = new Form_Builder_Wp_Eval_Math_Stack;
	...
	/**
	 * Class Form_Builder_Wp_Eval_Math_Stack.
	 */
	class Form_Builder_Wp_Eval_Math_Stack {
