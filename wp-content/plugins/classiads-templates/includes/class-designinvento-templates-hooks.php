...
class Classiads_Templates_Hooks {
	/**
	...
	/**
	 * Wrapper function for the before all import action hook.
	 *
	 * @param int $selected_import_index The selected demo import index.
	 */
	public function after_all_import_action() {
		do_action('designinvento_templates_after_all_import');
	...
	/* public function after_all_import_action( $selected_import_index ) {
		//do_action( 'designinvento_templates_after_all_import', $selected_import_index );
