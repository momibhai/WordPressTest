...
function directorypress_listing_submit_admin_info_function($field = ''){
	...
	if(!empty($field) && current_user_can('administrator')){
		echo '<a class="admin_info_link" href="#" data-toggle="modal" data-target="#admin_info_modal" data-field="'. esc_attr($field).'"><i class="fas fa-info"></i> '.esc_html__('Admin Docs', 'DIRECTORYPRESS').'</a>';	
	}
}
