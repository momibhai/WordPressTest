<?php global $directorypress_object; ?>
	<div class="field-wrap social-media-field clearfix">
		<p class="directorypress-submit-section-label directorypress-submit-field-title">
			...
			<?php do_action('directorypress_listing_submit_user_info', esc_attr__('By checking this option you allow registered users to claim this listing.', 'directorypress-frontend')); ?>
