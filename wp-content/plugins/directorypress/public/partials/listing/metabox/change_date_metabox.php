...
<div class="directorypress-content-wrap-fields-metabox">
	<div class="row directorypress-field directorypress-form-group directorypress-form-horizontal">
		...
		<div class="col-md-4 col-sm-4 col-xs-12">
			...
			<select name="expiration_date_hour" class="form-control directorypress-select2">
		...
		<div class="col-md-4 col-sm-4 col-xs-12">
			...
			<select name="expiration_date_minute" class="form-control directorypress-select2">
