						...
						echo '<div class="dropdown-content '. $settings['user_dropdown_menu_direction'] .'">';
							echo '<ul class="clearfix">';
								if($settings['user_menu_dropdown'] == 'custom'){
									...
									echo '<li><a href="'. directorypress_dashboardUrl(array('directorypress_action' => 'profile')) .'"><i class="fas fa-user"></i>'. esc_html__('Edit Profile', 'designinvento-elementor-widgets') .'</a></li>';
