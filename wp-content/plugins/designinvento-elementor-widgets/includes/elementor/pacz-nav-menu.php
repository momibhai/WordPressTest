...
class Pacz_Nav_Menu extends Widget_Base {
	...
	public function scripts() {
			wp_register_style('pacz-nav-menu', DEW_ASSETS_URL . 'css/nav-menu.css');
	...
	public function get_title() {
		return __( 'Designinvento Menu', 'header-footer-builder' );
	}
	...
	protected function register_desktop_layout_controls() {
		$this->start_controls_section(
				'section_layout',
				[
					'label' => __( 'Desktop Layout', 'header-footer-builder' ),
				]
		);
	...
	protected function register_responsive_layout_controls() {
		$this->start_controls_section(
				...
				[
					'label' => __( 'Responsive Layout', 'header-footer-builder' ),
				]
		);
		$this->add_control(
			'dropdown',
		...
		$this->add_control(
			...
			[
				...
				'label'     => __( 'Author Section', 'header-footer-builder' ),
				'separator' => 'before',
			]
		);
		$this->add_control(
			'author_section',
			[
				'label'        => __( 'Enable Author Info Section', 'header-footer-builder' ),
				'type'         => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'logged_out_content',
			[
				'label' => __( 'Logged out user content after author info', 'header-footer-builder' ),
		...
		$this->add_control(
			'logged_in_content',
			[
				'label' => __( 'Logged in user content after author info', 'header-footer-builder' ),
				'type' => Controls_Manager::WYSIWYG,
				'default' => '',
				/* 'condition' => [
					'author_section' => 1,
	...
	protected function register_dropdown_content_controls() {
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				[
					'label'     => __( 'Author Section Background Color', 'header-footer-builder' ),
					'type'      => Controls_Manager::COLOR,
					'selectors' => [
		...
		$this->start_controls_section(
			'style_toggle',
			[
				'label' => __( 'Responsive Menu Icon', 'header-footer-builder' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label'              => __( 'Icon Width', 'header-footer-builder' ),
				'type'               => Controls_Manager::SLIDER,
				'range'              => [
					'px' => [
						'min' => 20,
		...
		$this->add_responsive_control(
			...
			[
				'label'              => __( 'Icon Height', 'header-footer-builder' ),
				'type'               => Controls_Manager::SLIDER,
				'range'              => [
					'px' => [
						'min' => 20,
		...
		$this->add_responsive_control(
			...
			$this->add_control(
				...
				[
					'label'     => __( 'Menu close icon background color', 'header-footer-builder' ),
					'type'      => Controls_Manager::COLOR,
					'selectors' => [
			...
			$this->add_control(
				...
				[
					'label'     => __( 'Menu close icon color', 'header-footer-builder' ),
					'type'      => Controls_Manager::COLOR,
					'selectors' => [
