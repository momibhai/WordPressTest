...
class Difp_Directory
  {
	...
	/*function menu( $menu ) {
	 	...
	 	$menu['directory']	= array(
					'title'			=> __('Directory', 'directorypress-frontend-messages'),
					'action'			=> 'directory',
					'priority'			=> 25
					);
    ...
    {
		if ( ! difp_current_user_can( 'access_directory') ) {
	  		echo "<div class='alert alert-danger'>".__("You do not have permission to access directory!", 'directorypress-frontend-messages')."</div>";
			return;
	  	}
