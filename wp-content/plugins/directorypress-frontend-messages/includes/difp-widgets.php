...
class DIFP_menu_widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'DIFP Menu Widget', 'directorypress-frontend-messages' ), // Name
			array( 'description' => __( 'DesignInvento Messaging System Menu Widget', 'directorypress-frontend-messages' ), ) // Args
		);
	}
	...
	public function form( $instance ) {
		$title = isset( $instance['title'] ) ? $instance['title'] : __( 'DIFP Menu Widget', 'directorypress-frontend-messages' );
		?>
		<p>
...
class DIFP_text_widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'DIFP Text Widget', 'directorypress-frontend-messages' ), // Name
			array( 'description' => __( 'DesignInvento Messaging System Text Widget', 'directorypress-frontend-messages' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		$show_announcement = isset( $instance['show_announcement'] ) ? $instance['show_announcement'] : false;
			...
			echo __('Welcome', 'directorypress-frontend-messages') . ' ' . difp_get_userdata( $user_ID, 'display_name', 'id' ). '<br />';
			
			echo __('You have', 'directorypress-frontend-messages');
		...
		if ( $show_messagebox && $show_announcement )
				echo __(' and', 'directorypress-frontend-messages');
	 ...
	 */
	public function form( $instance ) {
		$title =  isset( $instance['title'] ) ? $instance['title'] : __( 'DIFP Text Widget', 'directorypress-frontend-messages' );
		$show_messagebox =  isset( $instance['show_messagebox'] ) ? $instance['show_messagebox'] : false;
		$show_announcement =  isset( $instance['show_announcement'] ) ? $instance['show_announcement'] : false;
		?>
		<p>
    	...
    	<label for="<?php echo $this->get_field_id( 'show_messagebox' ); ?>"><?php _e('Show Messagebox?', 'directorypress-frontend-messages'); ?></label>
		</p>
		<p>
    	...
    	<label for="<?php echo $this->get_field_id( 'show_announcement' ); ?>"><?php _e('Show Announcement?', 'directorypress-frontend-messages'); ?></label>
		</p>
		<?php 
	}
...
class DIFP_empty_widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			__( 'DIFP Empty Widget', 'directorypress-frontend-messages' ), // Name
			array( 'description' => __( 'DesignInvento Messaging System Empty Widget', 'directorypress-frontend-messages' ), ) // Args
		);
	}
	 ...
	 */
	public function form( $instance ) {
		$title = isset( $instance['title'] ) ? $instance['title'] : __( 'DIFP Empty Widget', 'directorypress-frontend-messages' );
		$show_help = isset( $instance['show_help'] ) ? $instance['show_help'] : false;
		?>
		<p>
		<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:' ); ?></label> 
    	...
    	<label for="<?php echo $this->get_field_id( 'show_help' ); ?>"><?php _e('Display help to configure this widget in front end?', 'directorypress-frontend-messages'); ?></label>
		</p>
		<?php 
	}
