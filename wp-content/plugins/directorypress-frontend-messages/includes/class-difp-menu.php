...
class Difp_Menu
  {
	...
	private function get_menu()
	{
		$menu = array(
				//'newmessage'	=> array(
					//'title'			=> __('New Message', 'directorypress-frontend-messages'),
					//'action'			=> 'newmessage',
				//	'priority'			=> 5
				//	),
				'message_box'	=> array(
					'title'			=> sprintf(__('Message Box%s', 'directorypress-frontend-messages'), difp_get_new_message_button() ),
					'action'			=> 'messagebox',
					'priority'			=> 10
					),
				'settings'	=> array(
					'title'			=> __('Settings', 'directorypress-frontend-messages'),
					'action'			=> 'settings',
					'priority'			=> 15
					),
				'announcements'	=> array(
					'title'			=> sprintf(__('Announcement%s', 'directorypress-frontend-messages'), difp_get_new_announcement_button() ),
