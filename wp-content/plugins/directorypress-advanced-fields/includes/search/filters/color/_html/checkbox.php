				...
				foreach ($search_field->field->selection_items AS $key=>$item){
					...
					echo '<div class="search-checkbox">';
						echo '<label>';
							...
							echo '</span>';
							echo '<span class="search-checkbox-item" style=" background:'. $search_field->field->color_codes[$key] .';border-color:'. $search_field->field->color_codes[$key] .';color:#fff;"></span>';
						echo '</label>';
					echo '</div>';
				}
			echo '</div>';
