...
class Elkit_Section_Effect_Controls{
    ...
    public function register_controls($control, $args)
    {
        $control->start_controls_section(
            'elkit_section_parallax',
            [
                'label' => esc_html__('Elkit Effects', 'elementskit'),
                'tab' => Controls_Manager::TAB_ADVANCED,
            ]
        );
        $control->add_control(
            'elkit_section_parallax_bg',
            [
        ...
        $control->add_control(
            'elkit_section_parallax_bg_speed', [
                ...
                'default' => 0.5,
                'condition' => [
                    'elkit_section_parallax_bg' => 'yes',
                ]
            ]
        );

        $control->add_control(
            'elkit_section_parallax_multi',
            array(
            ...
            [
                ...
                'device_args' => [
                    Controls_Stack::RESPONSIVE_TABLET => [
                        'condition' => [
                            'elkit_prlx_width_tablet' => [ 'custom' ],
                        ],
                    ],
                    Controls_Stack::RESPONSIVE_MOBILE => [
                        'condition' => [
                            'elkit_prlx_width_mobile' => [ 'custom' ],
                        ],
                    ],
                ],
                'size_units' => [ 'px', '%', 'vw' ],
        ...
        $repeater->add_responsive_control(
            'pos_x', [
                ...
                'selectors' => [
                    "{{WRAPPER}} {{CURRENT_ITEM}}.elkit-section-parallax-layer" => 'left: {{SIZE}}{{UNIT}}',
                ],
        ...
        $repeater->add_responsive_control(
            'pos_y',[
                ...
                'selectors' => [
                    "{{WRAPPER}} {{CURRENT_ITEM}}.elkit-section-parallax-layer" => 'top: {{SIZE}}{{UNIT}}',
        ...
        $repeater->add_responsive_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'elkit-bounce'=> 'Bounce',
                    'elkit-zoom'=> 'Zoom',
                    'elkit-rotate-box'=> 'RotateBox',
                    'elkit-left-right'=> 'Left Right',
                    'bounce'=> 'Bounce 2',
                    'flash'=> 'Flash',
                    'pulse'=> 'Pulse',
                    'shake'=> 'Shake',
        ...
        $control->add_control(
            'elkit_section_parallax_multi_items',
            [
                ...
                'condition' => [
                    'elkit_section_parallax_multi' => 'yes'
                ],
        ...
        $control->add_control(
            'elkit_section_parallax_overflow',
            [
