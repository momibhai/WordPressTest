...
class Copyright extends Widget_Base {
	...
	public function get_title() {
		return __( 'Copyright', 'header-footer-builder' );
	}
	/**
	...
	public function get_icon() {
		return 'hfb-icon-copyright-widget';
	}
	/**
	...
	protected function register_content_copy_right_controls() {
		$this->start_controls_section(
			'section_title',
			[
				'label' => __( 'Copyright', 'header-footer-builder' ),
			]
		);
		...
		$this->add_control(
			'shortcode',
			[
				'label'   => __( 'Copyright Text', 'header-footer-builder' ),
				'type'    => Controls_Manager::TEXTAREA,
				'dynamic' => [
					'active' => true,
				],
				'default' => __( 'Copyright © [hfb_current_year] [hfb_site_title] | Powered by [hfb_site_title]', 'header-footer-builder' ),
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'          => [
					'{{WRAPPER}} .hfb-copyright-wrapper' => 'text-align: {{VALUE}};',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .hfb-copyright-wrapper a, {{WRAPPER}} .hfb-copyright-wrapper' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .hfb-copyright-wrapper, {{WRAPPER}} .hfb-copyright-wrapper a',
				'global'   => [
	...
	protected function render() {
		...
		<div class="hfb-copyright-wrapper">
			<?php if ( ! empty( $link ) ) { ?>
