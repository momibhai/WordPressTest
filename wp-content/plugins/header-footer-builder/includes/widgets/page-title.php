...
class Page_Title extends Widget_Base {
	...
	public function get_title() {
		return __( 'Page Title', 'header-footer-builder' );
	}
	...
	protected function register_content_page_title_controls() {
		...
		$this->add_control(
			...
			[
				'label'       => __( 'Select Icon', 'header-footer-builder' ),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .hfb-page-title-icon' => 'margin-right: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'            => '',
				'selectors'          => [
					'{{WRAPPER}} .hfb-page-title-wrapper' => 'text-align: {{VALUE}};',
				],
	...
	protected function register_page_title_style_controls() {
		$this->start_controls_section(
			...
			$this->add_group_control(
				...
				[
					...
					'selector' => '{{WRAPPER}} .elementor-heading-title, {{WRAPPER}} .hfb-page-title a',
				]
			);
			...
			$this->add_control(
				...
				[
					...
					'selectors' => [
						'{{WRAPPER}} .elementor-heading-title, {{WRAPPER}} .hfb-page-title a' => 'color: {{VALUE}};',
						'{{WRAPPER}} .hfb-page-title-icon i'   => 'color: {{VALUE}};',
						'{{WRAPPER}} .hfb-page-title-icon svg' => 'fill: {{VALUE}};',
					],
				]
			);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .hfb-page-title-icon:hover i'   => 'color: {{VALUE}};',
					'{{WRAPPER}} .hfb-page-title-icon:hover svg' => 'fill: {{VALUE}};',
				],
			]
		);
	...
	protected function render() {
		...
		?>		
		<div class="hfb-page-title hfb-page-title-wrapper elementor-widget-heading">
		...
		?>
			...
			<<?php echo $heading_size_tag; ?> class="elementor-heading-title elementor-size-<?php echo $settings['size']; ?>">
				<?php if ( '' !== $settings['new_page_title_select_icon']['value'] ) { ?>
						<span class="hfb-page-title-icon">
		...
		<div class="hfb-page-title hfb-page-title-wrapper elementor-widget-heading">
			...
			<{{{ headingSizeTag }}} class="elementor-heading-title elementor-size-{{{ settings.size }}}">		
				<# if( '' != settings.new_page_title_select_icon.value ){ #>
					<span class="hfb-page-title-icon" data-elementor-setting-key="page_title" data-elementor-inline-editing-toolbar="basic">
						{{{iconHTML.value}}}                    
					</span>
				<# } #>
					<# if ( '' != settings.before ) { #>
