 ...
 * @copyright   Copyright (c) 2019, Header Footer Builder
 * @link        https://github.com/Nikschavan/header-footer-builder/
 * @since       HFB 1.1.4
 */
...
if ( ! class_exists( 'HFB_Update' ) ) {

	/**
	 * HFB_Update initial setup
	 *
	 * @since 1.1.4
	 */
	class HFB_Update {
		 ...
		 * @var string
		 */
		private $db_option_key = '_hfb_db_version';
		...
		public function get_legacy_template_id( $type ) {
			...
			$args     = apply_filters( 'hfb_get_template_id_args', $args );
		...
		private function needs_db_update() {
			...
			if ( false === $db_version || version_compare( $db_version, HEADER_FOOTER_BUILDER_VERSION ) ) {
				return true;
			}
		...
		private function update_db_version() {
			update_option( $this->db_option_key, HEADER_FOOTER_BUILDER_VERSION );
		}
	}
}
