<?php
/**
 * WPML Compatibility for Header Footer Builder.
 *
 * @package     HFB
 * @author      HFB
 ...
 */
class HFB_WPML_Compatibility {

	/**
	 * Instance of HFB_WPML_Compatibility.
	 *
	 * @since  1.0.9
	 * @var null
	 */
	...
	/**
	 * Get instance of HFB_WPML_Compatibility
	 *
	 * @since  1.0.9
	 * @return HFB_WPML_Compatibility
	 */
	...
	private function __construct() {
		add_filter( 'hfb_get_settings_type_header', [ $this, 'get_wpml_object' ] );
		add_filter( 'hfb_get_settings_type_footer', [ $this, 'get_wpml_object' ] );
		add_filter( 'hfb_get_settings_type_before_footer', [ $this, 'get_wpml_object' ] );
		add_filter( 'hfb_render_template_id', [ $this, 'get_wpml_object' ] );
	}
 ...
 * Initiate the class.
 */
HFB_WPML_Compatibility::instance();
